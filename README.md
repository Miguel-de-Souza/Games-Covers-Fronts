...
<li>All covers include console logos, with the exception of platforms like PC, Java and some modern PS5 games, which don't have an official logo.</li>
<li>This repository only contains game front covers.</li>
<li>The repository is not intended for task automation, and is named by the game name rather than its Serial like most front cover repositories. How BLES01976 > Minecraft (PS3)</li>
...
<ul>
  ...
  <li>Todas as capas incluem os logotipos dos consoles, com exceção de plataformas como PC, Java e alguns jogos de PS5 modernos, que não possuem um logo oficial</li>
  <li>Este repositório contém apenas capas frontais dos jogos.</li>
  <li>O repositório não é voltado para automação de tarefas, sendo nomeados pelo nome do jogo ao invés de sua Serial como a maioria dos repositórios de capas frontais. Como BLES01976 > Minecraft (PS3)</li>
